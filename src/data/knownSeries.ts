...
export const knownSeries: KnownSeries[] = [
  // ==========================================================================
  // FANTASY
  // ==========================================================================
  {
 ...
 */
export function getKnownSeriesByGenre(genre: string): KnownSeries[] {
  return knownSeries.filter(s => s.genre === genre);
}

/**
 * Get a specific known series by name
 */
export function getKnownSeries(name: string): KnownSeries | undefined {
  return knownSeries.find(s => 
