...
export const GENRE_LISTS: Record<string, string[]> = {
  romance: [
    ...
    '/list/show/42568.Best_Romance_Books_of_2020',
  ],
  mystery: [
  ...
  biography: [
    ...
    '/list/show/1252.Best_Autobiographies',
  ],
  history: [
  ...
  'true-crime': [
    ...
    '/list/show/2624.Best_True_Crime_Books',
  ],
  'self-help': [
    '/list/show/2787.Best_Self_Help_Books',
    '/list/show/264.Books_That_Will_Change_Your_Life',
    '/list/show/1128.Best_Personal_Development_Books',
  ],
  fiction: [
    '/list/show/264.Books_That_Will_Change_Your_Life',
